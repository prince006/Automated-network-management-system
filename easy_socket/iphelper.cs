...
namespace iphelper
{
    ...
    #region GetUdpExTable
        ...
        public static CMIB_UDPEXTABLE GetUdpExTable(bool bIpV6)
        {
            UInt32 error_code=0;
            return iphelper.GetUdpExTable(true,ref error_code,bIpV6);
        }
        public static CMIB_UDPEXTABLE GetUdpExTable(bool b_verbose,ref UInt32 error_code,bool bIpV6)
        {
			System.OperatingSystem osInfo = System.Environment.OSVersion;
// todo : to implement
// require MIB_UDP6TABLE struct definition + display integration into FormStat
//			// if vista (to check) or upper (at least seven)
//			if ( (osInfo.Version.Major>=6) && bIpV6)
//			{
...
//			else
			{
				...
				if (osInfo.Version.Major>=6)
				{
					...
					error_code= GetExtendedUdpTable(lpTable,ref real_buffer_size,true,2,UDP_TABLE_CLASS.UDP_TABLE_OWNER_PID,0); // AF_INET = 2 , UDP_TABLE_OWNER_PID = 1, reserved = 0 
				}
				else
					error_code= AllocateAndGetUdpExTableFromStack(ref lpTable, true, GetProcessHeap(),0,2);// options = 0, AF_INET = 2
				if (error_code!=0)
				{
					if (b_verbose)
					{
				...
				real_buffer_size=NumEntries*CMIB_UDPEXROW.size_ex+4;
    ...
    #region GetTcpExTable
        ...
        public static CMIB_TCPEXTABLE GetTcpExTable(bool b_verbose,ref UInt32 error_code,bool bIpV6)
        {
			System.OperatingSystem osInfo = System.Environment.OSVersion;
// todo : to implement
// require MIB_TCP6TABLE_OWNER_PID struct definition + display integration into FormStat
//			// if vista (to check) or upper (at least seven)
//			if ( (osInfo.Version.Major>=6) && bIpV6)
//			{
...
#region GetUdpExTable class
    public class CMIB_UDPEXTABLE // MIB_UDPTABLE_OWNER_PID
    {
        public UInt32 dwNumEntries=0;  
    ...
    public class CMIB_UDPEXROW:CMIB_UDPROW // MIB_UDPROW_OWNER_PID
    {
...
#region GetTcpExTable class
    ...
    public class CMIB_TCPEXROW:CMIB_TCPROW // MIB_TCPROW_OWNER_PID
    {
