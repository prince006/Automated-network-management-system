...
namespace easy_socket.udp
{
    ...
    public class Socket_Server
    {
        ...
        private void receive()
        {
            ...
            while (this.event_Socket_Server_Data_Arrival==null)
            {
                // wait 100 ms 
    ...
    public class Socket_Data
    {
        ...
        public Socket_Data(string remote_host,int remote_port)
        {
            ...
            // enable broadcast by default for broadcast addresses (can be done only after socket creation in common_constructor)
            if (remote_host.EndsWith(".255"))
            {
