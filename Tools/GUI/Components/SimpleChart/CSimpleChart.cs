...
namespace Tools.GUI.Components.SimpleChart
{
    ...
    public class CSimpleChart:System.Windows.Forms.Panel
    {
        ...
        private float OnPaint_tmp_float;
        private float OnPaint_tmp_float2;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if ((this.show_vertical_left_axis_values&&this.vertical_left_axis.Visible)
                ||(this.show_vertical_right_axis_values&&this.vertical_right_axis.Visible))
            {
                // min axis value
                this.OnPaint_tmp_float=(float)(this.autosize_min_value-this.autosize_min_value%this.vertical_axis_tick_frequency);
                this.OnPaint_str=Math.Round(this.OnPaint_tmp_float,6).ToString();
                // max axis value
                this.OnPaint_tmp_float2=(float)(Math.Floor((this.autosize_max_value-this.OnPaint_tmp_float)/this.vertical_axis_tick_frequency));
                this.OnPaint_tmp_float2=this.OnPaint_tmp_float+this.OnPaint_tmp_float2*this.vertical_axis_tick_frequency;
                this.OnPaint_str2=Math.Round(this.OnPaint_tmp_float2,6).ToString();

                // get the max string of axis min, axis max, vertical_axis_tick_frequency
                if (this.OnPaint_str.Length<this.OnPaint_str2.Length)
                    this.OnPaint_str=this.OnPaint_str2;
                this.OnPaint_str2=Math.Round(this.vertical_axis_tick_frequency,6).ToString();
                if (this.OnPaint_str.Length<this.OnPaint_str2.Length)
                    this.OnPaint_str=this.OnPaint_str2;
            }
            if (this.show_vertical_left_axis_values&&this.vertical_left_axis.Visible)
            ...
            if (this.show_horizontal_grid)
            {
                ...
                {
                    if (Math.Round(this.OnPaint_cnt_float,6)==0)// calcul precision <10^-7 --> we concider it's null
                        continue;
                    e.Graphics.DrawLine(
                ...
                for (this.OnPaint_cnt_float=(float)(this.autosize_min_value-this.autosize_min_value%this.vertical_axis_tick_frequency);this.OnPaint_cnt_float<=this.autosize_max_value;this.OnPaint_cnt_float+=this.vertical_axis_tick_frequency)
                {
                    ...
                    if (this.vertical_axis_negative_value_seem_positive)
                    {
                        ...
                        Tools.Drawing.CDrawString.DrawLegend(
                            e.Graphics,
                            Math.Abs(Math.Round(this.OnPaint_cnt_float,6)).ToString(),
                            this.vertical_left_axis_values_angle,
                    ...
                    else
                    {
                        ...
                        Tools.Drawing.CDrawString.DrawLegend(
                            e.Graphics,
                            Math.Round(this.OnPaint_cnt_float,6).ToString(),
                            this.vertical_left_axis_values_angle,
                            Tools.Drawing.CDrawString.TEXT_POSITION.OUTSIDE_LEFT,
                            0,
                            this.vertical_left_axis.Label.Brush,
            ...
            if (this.vertical_right_axis.Visible&&this.show_vertical_right_axis_values)
            {
                for (this.OnPaint_cnt_float=(float)(this.autosize_min_value-this.autosize_min_value%this.vertical_axis_tick_frequency);this.OnPaint_cnt_float<=this.autosize_max_value;this.OnPaint_cnt_float+=this.vertical_axis_tick_frequency)
                {
                    if (Math.Round(this.OnPaint_cnt_float,6)==0)
                        continue;
                    // draw value mark
                    e.Graphics.DrawLine(
                        this.horizontal_grid_pen,
