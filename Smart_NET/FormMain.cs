...
namespace Smart_NET
{
    public class FormMain : System.Windows.Forms.Form
    {
		...
		private System.Windows.Forms.CheckBox checkBox_Bind_To_IpAddrAny;
		private System.Windows.Forms.Label StatsAvailableonlyForAdmins;
		private System.Windows.Forms.CheckBox checkBoxStatsIPV6;
		private System.Windows.Forms.Label label42;
		private System.Windows.Forms.TextBox textBox_icmp_delay_between_ping_sending;
		...
		protected COptions Options;
		protected void LoadOptions()
		{
			 
			this.ConfigFileName = System.Windows.Forms.Application.StartupPath + "\\config.xml";
			this.Options = COptions.Load(this.ConfigFileName);
			// tcp server
			this.textBox_TCP_Server_IP.Text = Options.textBox_TCP_Server_IP;
			this.textBox_TCP_Server_Port.Text= Options.textBox_TCP_Server_Port;

			// tcp client
			this.textBox_TCP_Client_IP.Text = Options.textBox_TCP_Client_IP;
			this.textBox_TCP_Client_Port.Text = Options.textBox_TCP_Client_Port;
			this.checkBox_TCP_Client_telnet_protocol.Checked = Options.checkBox_TCP_Client_telnet_protocol;
			this.checkBox_TCP_Client_Specify_local_port.Checked = Options.checkBox_TCP_Client_Specify_local_port;
			this.textBox_TCP_Client_local_port.Text = Options.textBox_TCP_Client_local_port;

			// udp server
			this.textBox_UDP_Server_IP.Text = Options.textBox_UDP_Server_IP;
			this.textBox_UDP_Server_Port.Text = Options.textBox_UDP_Server_Port;
			this.checkBox_UDP_Server_echo.Checked = Options.checkBox_UDP_Server_echo;
			this.checkBox_Bind_To_IpAddrAny.Checked = Options.checkBox_Bind_To_IpAddrAny;
			
			// udp client
			this.textBox_UDP_Client_IP.Text = Options.textBox_UDP_Client_IP;
			this.textBox_UDP_Client_Port.Text = Options.textBox_UDP_Client_Port;
			this.checkBox_UDP_Client_Specify_local_port.Checked = Options.checkBox_UDP_Client_Specify_local_port;
			this.textBox_UDP_Client_local_port.Text = Options.textBox_UDP_Client_local_port;
			this.checkBox_UDP_Client_watch_for_reply.Checked = Options.checkBox_UDP_Client_watch_for_reply;
			
			
			// icmp
			this.textBox_icmp_ip.Text = Options.textBox_icmp_ip;
			this.textBox_icmp_delay_for_reply.Text = Options.textBox_icmp_delay_for_reply;
			this.textBox_icmp_packet_ttl.Text = Options.textBox_icmp_packet_ttl;
			this.textBox_icmp_ping_number.Text = Options.textBox_icmp_ping_number;
			this.textBox_icmp_delay_between_ping_sending.Text = Options.textBox_icmp_delay_between_ping_sending;
			this.checkBox_icmp_looping_ping.Checked = Options.checkBox_icmp_looping_ping;
			this.checkBox_icmp_may_broadcast.Checked = Options.checkBox_icmp_may_broadcast;
			this.textBox_icmp_start_with_hop.Text = Options.textBox_icmp_start_with_hop;
			this.textBox_icmp_end_with_hop.Text = Options.textBox_icmp_end_with_hop;
			this.checkBox_icmp_resolve_adresses.Checked = Options.checkBox_icmp_resolve_adresses;
				
			// transparent proxy
			this.textBox_interactive_tcp_proxy_ip.Text = Options.textBox_interactive_tcp_proxy_ip;
			this.textBox_interactive_tcp_proxy_port.Text = Options.textBox_interactive_tcp_proxy_port;
			this.textBox_interactive_udp_proxy_ip.Text = Options.textBox_interactive_udp_proxy_ip;
			this.textBox_interactive_udp_proxy_port.Text = Options.textBox_interactive_udp_proxy_port;
			this.textBox_interactive_remote_host_ip.Text = Options.textBox_interactive_remote_host_ip;
			this.textBox_interactive_remote_host_port.Text = Options.textBox_interactive_remote_host_port;
			
			// dns
			this.textBox_dns_ip.Text = Options.textBox_dns_ip;
			
			// whois
			this.textBox_whois_ip.Text = Options.textBox_whois_ip;
			this.radioButton_whois_auto_find.Checked = Options.radioButton_whois_auto_find;
			this.radioButton_whois_use_following.Checked = Options.radioButton_whois_use_following;
			this.textBox_whois_server.Text = Options.textBox_whois_server;
			
			// arp
			this.textBox_arp_ip.Text = Options.textBox_arp_ip;
			
			// outside ip
			this.comboBox_outside_ip_server.Text = Options.comboBox_outside_ip_server;
			
			// wake on lan
			this.textBox_WOL_mac_address.Text = Options.textBox_WOL_mac_address;
			this.textBox_WOL_broadcast_ip.Text = Options.textBox_WOL_broadcast_ip;
			this.textBox_WOL_udp_port.Text = Options.textBox_WOL_udp_port;
			
			// remote shutdown
			this.textBox_remote_shutdown_computer_name.Text = Options.textBox_remote_shutdown_computer_name;
			this.textBox_remote_shutdown_message.Text = Options.textBox_remote_shutdown_message;
			this.numericUpDown_remote_shutdown_timeout.Text = Options.numericUpDown_remote_shutdown_timeout;
			this.checkBox_remote_shutdown_force_close.Checked = Options.checkBox_remote_shutdown_force_close;
			this.checkBox_remote_shutdown_reset.Checked = Options.checkBox_remote_shutdown_reset;
		}
		protected void SaveOptions()
		{
			// tcp server
			Options.textBox_TCP_Server_IP = this.textBox_TCP_Server_IP.Text;
			Options.textBox_TCP_Server_Port=this.textBox_TCP_Server_Port.Text;

			// tcp client
			Options.textBox_TCP_Client_IP =this.textBox_TCP_Client_IP.Text;
			Options.textBox_TCP_Client_Port =this.textBox_TCP_Client_Port.Text;
			Options.checkBox_TCP_Client_telnet_protocol =this.checkBox_TCP_Client_telnet_protocol.Checked;
			Options.checkBox_TCP_Client_Specify_local_port =this.checkBox_TCP_Client_Specify_local_port.Checked;
			Options.textBox_TCP_Client_local_port =this.textBox_TCP_Client_local_port.Text;

			// udp server
			Options.textBox_UDP_Server_IP = this.textBox_UDP_Server_IP.Text;
			Options.textBox_UDP_Server_Port = this.textBox_UDP_Server_Port.Text;
			Options.checkBox_UDP_Server_echo = this.checkBox_UDP_Server_echo.Checked;
			Options.checkBox_Bind_To_IpAddrAny = this.checkBox_Bind_To_IpAddrAny.Checked;
			
			// udp client
			Options.textBox_UDP_Client_IP = this.textBox_UDP_Client_IP.Text;
			Options.textBox_UDP_Client_Port = this.textBox_UDP_Client_Port.Text;
			Options.checkBox_UDP_Client_Specify_local_port = this.checkBox_UDP_Client_Specify_local_port.Checked;
			Options.textBox_UDP_Client_local_port = this.textBox_UDP_Client_local_port.Text;
			Options.checkBox_UDP_Client_watch_for_reply = this.checkBox_UDP_Client_watch_for_reply.Checked;
			
			
			// icmp
			Options.textBox_icmp_ip = this.textBox_icmp_ip.Text;
			Options.textBox_icmp_delay_for_reply = this.textBox_icmp_delay_for_reply.Text;
			Options.textBox_icmp_packet_ttl = this.textBox_icmp_packet_ttl.Text;
			Options.textBox_icmp_ping_number = this.textBox_icmp_ping_number.Text;
			Options.textBox_icmp_delay_between_ping_sending = this.textBox_icmp_delay_between_ping_sending.Text;
			Options.checkBox_icmp_looping_ping = this.checkBox_icmp_looping_ping.Checked;
			Options.checkBox_icmp_may_broadcast = this.checkBox_icmp_may_broadcast.Checked;
			Options.textBox_icmp_start_with_hop = this.textBox_icmp_start_with_hop.Text;
			Options.textBox_icmp_end_with_hop = this.textBox_icmp_end_with_hop.Text;
			Options.checkBox_icmp_resolve_adresses = this.checkBox_icmp_resolve_adresses.Checked;
				
			// transparent proxy
			Options.textBox_interactive_tcp_proxy_ip = this.textBox_interactive_tcp_proxy_ip.Text;
			Options.textBox_interactive_tcp_proxy_port = this.textBox_interactive_tcp_proxy_port.Text;
			Options.textBox_interactive_udp_proxy_ip = this.textBox_interactive_udp_proxy_ip.Text;
			Options.textBox_interactive_udp_proxy_port = this.textBox_interactive_udp_proxy_port.Text;
			Options.textBox_interactive_remote_host_ip = this.textBox_interactive_remote_host_ip.Text;
			Options.textBox_interactive_remote_host_port = this.textBox_interactive_remote_host_port.Text;
			
			// dns
			Options.textBox_dns_ip = this.textBox_dns_ip.Text;
			
			// whois
			Options.textBox_whois_ip = this.textBox_whois_ip.Text;
			Options.radioButton_whois_auto_find = this.radioButton_whois_auto_find.Checked;
			Options.radioButton_whois_use_following = this.radioButton_whois_use_following.Checked;
			Options.textBox_whois_server = this.textBox_whois_server.Text;
			
			// arp
			Options.textBox_arp_ip = this.textBox_arp_ip.Text;
			
			// outside ip
			Options.comboBox_outside_ip_server = this.comboBox_outside_ip_server.Text;
			
			// wake on lan
			Options.textBox_WOL_mac_address = this.textBox_WOL_mac_address.Text;
			Options.textBox_WOL_broadcast_ip = this.textBox_WOL_broadcast_ip.Text;
			Options.textBox_WOL_udp_port = this.textBox_WOL_udp_port.Text;
			
			// remote shutdown
			Options.textBox_remote_shutdown_computer_name = this.textBox_remote_shutdown_computer_name.Text;
			Options.textBox_remote_shutdown_message = this.textBox_remote_shutdown_message.Text;
			Options.numericUpDown_remote_shutdown_timeout = this.numericUpDown_remote_shutdown_timeout.Text;
			Options.checkBox_remote_shutdown_force_close = this.checkBox_remote_shutdown_force_close.Checked;
			Options.checkBox_remote_shutdown_reset = this.checkBox_remote_shutdown_reset.Checked;

			// do the saving
			this.Options.Save(this.ConfigFileName);
		}
        ...
        private void InitializeComponent()
        {
            ...
            this.checkBox_Bind_To_IpAddrAny = new System.Windows.Forms.CheckBox();
            ...
            this.textBox_icmp_delay_between_ping_sending = new System.Windows.Forms.TextBox();
            ...
            this.checkBoxStatsIPV6 = new System.Windows.Forms.CheckBox();
            ...
            this.StatsAvailableonlyForAdmins = new System.Windows.Forms.Label();
            ...
            this.textBox_UDP_Client_local_port.TabIndex = 5;
            ...
            this.checkBox_UDP_Client_Specify_local_port.TabIndex = 4;
            this.checkBox_UDP_Client_Specify_local_port.Text = "Specify local port";
            // 
            // checkBox_UDP_Client_watch_for_reply
            // 
            this.checkBox_UDP_Client_watch_for_reply.Location = new System.Drawing.Point(200, 40);
            ...
            this.textBox_UDP_Client_IP.TabIndex = 1;
            ...
            // 
            // checkBox_Bind_To_IpAddrAny
            // 
            this.checkBox_Bind_To_IpAddrAny.Location = new System.Drawing.Point(168, 40);
            this.checkBox_Bind_To_IpAddrAny.Name = "checkBox_Bind_To_IpAddrAny";
            this.checkBox_Bind_To_IpAddrAny.Size = new System.Drawing.Size(168, 16);
            this.checkBox_Bind_To_IpAddrAny.TabIndex = 6;
            this.checkBox_Bind_To_IpAddrAny.Text = "Allow to receive broadcast";
            // 
            ...
            this.checkBox_UDP_Server_echo.Size = new System.Drawing.Size(80, 16);
            this.checkBox_UDP_Server_echo.TabIndex = 4;
            this.checkBox_UDP_Server_echo.Text = "send echo";
            // 
            // textBox_UDP_Server_Port
            // 
            this.textBox_UDP_Server_Port.Location = new System.Drawing.Point(200, 16);
            this.textBox_UDP_Server_Port.Name = "textBox_UDP_Server_Port";
            this.textBox_UDP_Server_Port.Size = new System.Drawing.Size(48, 20);
            this.textBox_UDP_Server_Port.TabIndex = 3;
            ...
            this.textBox_UDP_Server_IP.TabIndex = 1;
            ...
            // button_UDP_Server
            // 
            this.button_UDP_Server.Location = new System.Drawing.Point(261, 16);
            this.button_UDP_Server.Name = "button_UDP_Server";
            this.button_UDP_Server.Size = new System.Drawing.Size(75, 23);
            this.button_UDP_Server.TabIndex = 5;
            ...
            this.textBox_TCP_Server_Port.TabIndex = 3;
            ...
            this.textBox_TCP_Server_IP.TabIndex = 1;
            ...
            this.button_TCP_Server.TabIndex = 4;
            ...
            this.checkBox_TCP_Client_telnet_protocol.TabIndex = 4;
            ...
            this.textBox_TCP_Client_local_port.TabIndex = 6;
            ...
            this.checkBox_TCP_Client_Specify_local_port.TabIndex = 5;
            ...
            this.textBox_TCP_Client_Port.TabIndex = 3;
            ...
            this.textBox_TCP_Client_IP.TabIndex = 1;
            ...
            this.button_TCP_Client.TabIndex = 7;
            ...
            this.button_scan_cgi.Size = new System.Drawing.Size(75, 23);
            ...
            this.button_scan_icmp.Size = new System.Drawing.Size(75, 23);
            ...
            this.button_scan_udp.Size = new System.Drawing.Size(75, 23);
            ...
            this.button_scan_tcp.Size = new System.Drawing.Size(75, 23);
            ...
            this.tabPage_icmp.Controls.Add(this.textBox_icmp_delay_for_reply);
            ...
            this.groupBox6.Location = new System.Drawing.Point(552, 0);
            this.groupBox6.Name = "groupBox6";
            this.groupBox6.Size = new System.Drawing.Size(176, 128);
            ...
            this.checkBox_icmp_resolve_adresses.TabIndex = 4;
            ...
            this.textBox_icmp_end_with_hop.TabIndex = 3;
            ...
            this.textBox_icmp_start_with_hop.TabIndex = 1;
            ...
            // groupBox5
            // 
            this.groupBox5.Controls.Add(this.textBox_icmp_delay_between_ping_sending);
            ...
            this.groupBox5.Size = new System.Drawing.Size(264, 128);
            this.groupBox5.TabIndex = 4;
            this.groupBox5.TabStop = false;
            this.groupBox5.Text = "Ping";
            // 
            // textBox_icmp_delay_between_ping_sending
            // 
            this.textBox_icmp_delay_between_ping_sending.Location = new System.Drawing.Point(200, 54);
            this.textBox_icmp_delay_between_ping_sending.Name = "textBox_icmp_delay_between_ping_sending";
            this.textBox_icmp_delay_between_ping_sending.Size = new System.Drawing.Size(40, 20);
            this.textBox_icmp_delay_between_ping_sending.TabIndex = 8;
            this.textBox_icmp_delay_between_ping_sending.Text = "0";
            this.textBox_icmp_delay_between_ping_sending.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
            // 
            // label42
            // 
            ...
            this.label42.Text = "Delay in ms between ping sending";
            // 
            // checkBox_icmp_may_broadcast
            // 
            this.checkBox_icmp_may_broadcast.Location = new System.Drawing.Point(8, 96);
            this.checkBox_icmp_may_broadcast.Name = "checkBox_icmp_may_broadcast";
            this.checkBox_icmp_may_broadcast.Size = new System.Drawing.Size(176, 16);
            this.checkBox_icmp_may_broadcast.TabIndex = 5;
            this.checkBox_icmp_may_broadcast.Text = "More than one host can reply";
            // 
            // checkBox_icmp_looping_ping
            // 
            this.checkBox_icmp_looping_ping.Location = new System.Drawing.Point(8, 74);
            ...
            // 
            this.textBox_icmp_ping_number.Location = new System.Drawing.Point(200, 34);
            ...
            // 
            this.textBox_icmp_delay_for_reply.Location = new System.Drawing.Point(224, 32);
            ...
            this.textBox_icmp_delay_for_reply.TabIndex = 3;
            ...
            this.textBox_icmp_ip.TabIndex = 1;
            ...
            // groupBox14
            // 
            this.groupBox14.Controls.Add(this.checkBoxStatsIPV6);
            ...
            // checkBoxStatsIPV6
            // 
            this.checkBoxStatsIPV6.Enabled = false;
            this.checkBoxStatsIPV6.Location = new System.Drawing.Point(208, 10);
            this.checkBoxStatsIPV6.Name = "checkBoxStatsIPV6";
            this.checkBoxStatsIPV6.Size = new System.Drawing.Size(56, 16);
            this.checkBoxStatsIPV6.TabIndex = 3;
            this.checkBoxStatsIPV6.Text = "IP v6";
            this.checkBoxStatsIPV6.CheckedChanged += new System.EventHandler(this.checkBoxStatsIPV6_CheckedChanged);
            // 
            // label40
            // 
            ...
            this.stats_interface_simple_chart.MaxValue = 50D;
            this.stats_interface_simple_chart.MinValue = 0D;
            ...
            this.stats_interface_simple_chart.TabIndex = 2;
            ...
            this.comboBox_stat_interface.TabIndex = 1;
            ...
            this.groupBox13.Controls.Add(this.StatsAvailableonlyForAdmins);
            ...
            this.button_ipnet_stats.Size = new System.Drawing.Size(75, 23);
            this.button_ipnet_stats.TabIndex = 3;
            ...
            this.button_ipnet_table.Size = new System.Drawing.Size(75, 23);
            this.button_ipnet_table.TabIndex = 2;
            ...
            this.button_icmp_stats.Size = new System.Drawing.Size(75, 23);
            this.button_icmp_stats.TabIndex = 6;
            ...
            this.button_udp_stats.Size = new System.Drawing.Size(75, 23);
            this.button_udp_stats.TabIndex = 5;
            ...
            this.button_udp_table.Size = new System.Drawing.Size(75, 23);
            this.button_udp_table.TabIndex = 4;
            ...
            this.button_tcp_stat.Size = new System.Drawing.Size(75, 23);
            this.button_tcp_stat.TabIndex = 1;
            ...
            this.button_tcp_table.Size = new System.Drawing.Size(75, 23);
            this.button_tcp_table.TabIndex = 0;
            ...
            this.stats_icmp_simple_chart.MaxValue = 50D;
            this.stats_icmp_simple_chart.MinValue = 0D;
            ...
            this.stats_icmp_simple_chart.TabIndex = 10;
            ...
            this.stats_udp_simple_chart.MaxValue = 50D;
            this.stats_udp_simple_chart.MinValue = 0D;
            ...
            this.stats_udp_simple_chart.TabIndex = 9;
            ...
            this.stats_ip_simple_chart.MaxValue = 50D;
            this.stats_ip_simple_chart.MinValue = 0D;
            ...
            this.stats_ip_simple_chart.TabIndex = 8;
            ...
            this.stats_tcp_simple_chart.MaxValue = 50D;
            this.stats_tcp_simple_chart.MinValue = 0D;
            ...
            this.stats_tcp_simple_chart.TabIndex = 7;
            ...
            // 
            // StatsAvailableonlyForAdmins
            // 
            this.StatsAvailableonlyForAdmins.Location = new System.Drawing.Point(88, 64);
            this.StatsAvailableonlyForAdmins.Name = "StatsAvailableonlyForAdmins";
            this.StatsAvailableonlyForAdmins.Size = new System.Drawing.Size(224, 23);
            this.StatsAvailableonlyForAdmins.TabIndex = 3;
            this.StatsAvailableonlyForAdmins.Text = "Available only for administrators";
            this.StatsAvailableonlyForAdmins.Visible = false;
            // 
            // tabPageInteractive
            // 
            ...
            this.textBox_interactive_udp_proxy_port.TabIndex = 3;
            ...
            this.textBox_interactive_udp_proxy_ip.TabIndex = 1;
            ...
            this.button_interactive_udp_proxy_start.TabIndex = 4;
            ...
            this.textBox_interactive_remote_host_port.TabIndex = 3;
            ...
            this.textBox_interactive_remote_host_ip.TabIndex = 1;
            ...
            this.textBox_interactive_tcp_proxy_port.TabIndex = 3;
            ...
            this.textBox_interactive_tcp_proxy_ip.TabIndex = 1;
            ...
            this.button_interactive_tcp_proxy_start.TabIndex = 4;
    ...
    "ese data. You act like man in the middle of the connection";
            ...
            this.label25.Size = new System.Drawing.Size(512, 32);
            this.label25.TabIndex = 3;
            this.label25.Text = "Allow you to forge any packet based on IP stack (available only for XP SP1 : Raw " +
    "packet support  removed by microsoft in sp2 and later OS)";
            // 
            // label24
            // 
            ...
            // 
            this.button_raw_packet_capture.Location = new System.Drawing.Point(112, 24);
            this.button_raw_packet_capture.Name = "button_raw_packet_capture";
            this.button_raw_packet_capture.Size = new System.Drawing.Size(75, 23);
            this.button_raw_packet_capture.TabIndex = 0;
            ...
            this.button_raw_packet_forge.Size = new System.Drawing.Size(75, 23);
            this.button_raw_packet_forge.TabIndex = 1;
            ...
            this.textBox_dns_result.TabIndex = 3;
            // 
            // textBox_dns_ip
            // 
            ...
            this.textBox_dns_ip.TabIndex = 1;
            ...
            // button_dns
            // 
            this.button_dns.Location = new System.Drawing.Point(320, 8);
            this.button_dns.Name = "button_dns";
            this.button_dns.Size = new System.Drawing.Size(88, 23);
            this.button_dns.TabIndex = 2;
            ...
            this.textBox_whois_server.TabIndex = 4;
            ...
            this.radioButton_whois_use_following.TabIndex = 3;
            ...
            this.radioButton_whois_auto_find.TabIndex = 2;
            ...
            this.button_whois.Size = new System.Drawing.Size(75, 23);
            ...
            this.textBox_arp_result.TabIndex = 4;
            // 
            // label8
            // 
            ...
            this.textBox_arp_ip.TabIndex = 1;
            ...
            this.button_arp.Size = new System.Drawing.Size(75, 23);
            this.button_arp.TabIndex = 2;
            ...
            this.groupBox8.Location = new System.Drawing.Point(96, 0);
            ...
            this.button_local_ip_refresh.Size = new System.Drawing.Size(75, 23);
            ...
            this.textBox_local_ip.Size = new System.Drawing.Size(184, 104);
            ...
            this.groupBox7.Location = new System.Drawing.Point(392, 0);
            this.groupBox7.Name = "groupBox7";
            this.groupBox7.Size = new System.Drawing.Size(288, 128);
            ...
            this.comboBox_outside_ip_server.TabIndex = 1;
            ...
            this.textBox_outside_ip_ip.Size = new System.Drawing.Size(136, 20);
            this.textBox_outside_ip_ip.TabIndex = 4;
            // 
            // button_outside_ip_get
            // 
            this.button_outside_ip_get.Location = new System.Drawing.Point(224, 96);
            this.button_outside_ip_get.Name = "button_outside_ip_get";
            this.button_outside_ip_get.Size = new System.Drawing.Size(56, 23);
            this.button_outside_ip_get.TabIndex = 2;
            ...
            this.textBox_WOL_broadcast_ip.Size = new System.Drawing.Size(100, 20);
            this.textBox_WOL_broadcast_ip.TabIndex = 3;
            ...
            this.textBox_WOL_mac_address.Size = new System.Drawing.Size(100, 20);
            this.textBox_WOL_mac_address.TabIndex = 1;
            ...
            this.button_WOL_wake_up.Size = new System.Drawing.Size(75, 23);
            ...
            this.textBox_WOL_udp_port.TabIndex = 5;
    ...
    "";
            ...
            this.button_remote_shutdown_abort.Size = new System.Drawing.Size(75, 23);
            this.button_remote_shutdown_abort.TabIndex = 9;
            ...
            this.button_remote_shutdown_initiate.Size = new System.Drawing.Size(75, 23);
            this.button_remote_shutdown_initiate.TabIndex = 8;
            ...
            this.numericUpDown_remote_shutdown_timeout.Maximum = new decimal(new int[] {
            -1,
            0,
            0,
            0});
            ...
            this.numericUpDown_remote_shutdown_timeout.TabIndex = 5;
            this.numericUpDown_remote_shutdown_timeout.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
            this.numericUpDown_remote_shutdown_timeout.Value = new decimal(new int[] {
            20,
            0,
            0,
            0});
            ...
            this.checkBox_remote_shutdown_reset.TabIndex = 7;
            ...
            this.checkBox_remote_shutdown_force_close.TabIndex = 6;
            ...
            this.textBox_remote_shutdown_message.TabIndex = 3;
            ...
            this.textBox_remote_shutdown_computer_name.TabIndex = 1;
            ...
            this.linkLabel_mail.Text = "Princekumar640035@gmail.com";
            ...
            this.label32.Size = new System.Drawing.Size(284, 18);
            this.label32.TabIndex = 3;
            this.label32.Text = "Asia Pacific Institute of Information Technology";
            // 
            // label31
            // 
            ...
            this.label31.Text = "Author : Prince kumar";
            // 
            // label30
            // 
            ...
            this.imageList_tabpage_menu.Images.SetKeyName(0, "");
            this.imageList_tabpage_menu.Images.SetKeyName(1, "");
            this.imageList_tabpage_menu.Images.SetKeyName(2, "");
            this.imageList_tabpage_menu.Images.SetKeyName(3, "");
            this.imageList_tabpage_menu.Images.SetKeyName(4, "");
            this.imageList_tabpage_menu.Images.SetKeyName(5, "");
            this.imageList_tabpage_menu.Images.SetKeyName(6, "");
            this.imageList_tabpage_menu.Images.SetKeyName(7, "");
            this.imageList_tabpage_menu.Images.SetKeyName(8, "");
            this.imageList_tabpage_menu.Images.SetKeyName(9, "");
            this.imageList_tabpage_menu.Images.SetKeyName(10, "");
            this.imageList_tabpage_menu.Images.SetKeyName(11, "");
            // 
            ...
            this.imageList_tabpage_icons.Images.SetKeyName(0, "");
            this.imageList_tabpage_icons.Images.SetKeyName(1, "");
            // 
            // panel_mdi_tab
            // 
        ...
        private void button_UDP_Server_Click(object sender, System.EventArgs e)
        {
            ...
            frm_srv.set_mdi_parent(this);
            frm_srv.Show();
            if (this.checkBox_Bind_To_IpAddrAny.Checked == true)
            {
                frm_srv.new_udp_server("",port,this.checkBox_UDP_Server_echo.Checked);// "" will be changed to IpAddrAny by easy_socket.udp_socket
            }
            else
            {
        ...
        {
            FormPing fp=new FormPing(this.textBox_icmp_ip.Text.Trim(),this.textBox_icmp_delay_for_reply.Text,
                this.textBox_icmp_packet_ttl.Text,this.textBox_icmp_ping_number.Text,this.textBox_icmp_delay_between_ping_sending.Text,
        ...
        {
            FormTrace ft=new FormTrace(this.textBox_icmp_ip.Text.Trim(),this.textBox_icmp_delay_for_reply.Text,
        ...
        private void button_tcp_table_Click(object sender, System.EventArgs e)
        {
			...
			fstat.SetIpVersion(this.checkBoxStatsIPV6.Checked);
            fstat.Show();
            fstat.get_tcp_table();
        }
        ...
        {
			this.StatsAvailableonlyForAdmins.Visible = true;
            if (this.stats_simple_chart_array==null)
                return;
        ...
        // this part is not available for 98 and CE
        private void stat_init_charts()
        {
			...
			// set charts according to os in ip v4 mode by default
			if (!this.SetCharts(false))
				return;

			System.OperatingSystem osInfo = System.Environment.OSVersion;
			// if vista (to check) or upper (at least seven)
			if (osInfo.Version.Major>=6)
			{
				// enbale ip v6 check box
				this.checkBoxStatsIPV6.Enabled = true;
			}
            ...
            for (int cnt=0;cnt<this.stats_simple_chart_array.Length;cnt++)
            {
                ...
                // no legend because not enought place
		...
		private void checkBoxStatsIPV6_CheckedChanged(object sender, System.EventArgs e)
		{
			this.SetCharts(this.checkBoxStatsIPV6.Checked);
		}

		bool SetCharts(bool bIPV6)
		{
			try // catch not supported os errors
			{
				...
				if (osInfo.Version.Major>=6)
				{
					if (bIPV6)
					{
						...
						{
							new System.Diagnostics.PerformanceCounter( "TCPv6","Segments Received/sec"),
							new System.Diagnostics.PerformanceCounter( "TCPv6","Segments Sent/sec"),
							new System.Diagnostics.PerformanceCounter( "IPv6","Datagrams Received/sec"),
							new System.Diagnostics.PerformanceCounter( "IPv6","Datagrams Sent/sec"),
							new System.Diagnostics.PerformanceCounter( "UDPv6","Datagrams Received/sec"),
							new System.Diagnostics.PerformanceCounter( "UDPv6","Datagrams Sent/sec"),
							new System.Diagnostics.PerformanceCounter( "ICMPv6","Messages Received/sec"),
							new System.Diagnostics.PerformanceCounter( "ICMPv6","Messages Sent/sec"),
        ...
        {
            this.VisitLink("mailto:pt1082250@apiit.edu.in");
