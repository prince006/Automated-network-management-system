...
namespace Smart_NET
{
    ...
    public class FormStat : System.Windows.Forms.Form
    {
		...
		bool bUseIpv6 = false;
		public void SetIpVersion(bool bIPv6)
		{
			this.bUseIpv6 = bIPv6;
		}
        ...
        private void resize_list()
        {
            ...
            if (i_new_size>200)
            {
                ...
                // make proportional growth of columns width
                ...
                if (full_size<this.listView_stats.Width-25)// error comparison
                {
        ...
        private bool is_xp_os_or_newer()
        {
        ...
        public void get_tcp_table()
        {
            try
            {
                ...
                if (this.is_xp_os_or_newer())
                {
                    iphelper.CMIB_TCPEXTABLE table=iphelper.iphelper.GetTcpExTable(this.bUseIpv6);
                    if (table==null)
                        return;
        ...
        public void get_udp_table()
        {
            try
            {
                ...
                if (this.is_xp_os_or_newer())
                {
                    iphelper.CMIB_UDPEXTABLE table=iphelper.iphelper.GetUdpExTable(this.bUseIpv6);
                    if (table==null)
                        return;
        ...
        private void menuItem_close_connection_Click(object sender, System.EventArgs e)
        {
            ...
            int nb_entry;
            bool b_xp_os=this.is_xp_os_or_newer();
            if (b_xp_os)
        ...
        private void change_enabled_menu_tcp_table(bool enable)
        {
            ...
            if (this.menuItem_end_process.Visible)
                this.menuItem_end_process.Visible=this.is_xp_os_or_newer();
