...
namespace Smart_NET
{
    public class FormWhois : CommonTelnetForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // textBox_editable
            // 
            this.textBox_editable.Location = new System.Drawing.Point(0, 172);
            this.textBox_editable.Name = "textBox_editable";
            this.textBox_editable.Size = new System.Drawing.Size(264, 57);
            // 
            // panel_control
            // 
            ...
            this.textBox_telnet.Size = new System.Drawing.Size(264, 172);
            ...
            this.textBox_whois_ip.TabIndex = 0;
            ...
            this.textBox_whois_server.TabIndex = 3;
            ...
            this.radioButton_whois_use_following.TabIndex = 2;
            ...
            this.radioButton_whois_auto_find.TabIndex = 1;
        ...
        private void button_whois_Click(object sender, System.EventArgs e)
        {
            ...
            if (this.radioButton_whois_auto_find.Checked)
                this.whois_server=find_best_whois_server(ip);
            else
                this.whois_server=this.textBox_whois_server.Text;

            this.data_to_send=ip;
            if (this.whois_server=="")
            {
                this.panel_control.Enabled=true;
                return;
            }
