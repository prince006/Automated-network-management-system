...
namespace Smart_NET.FormScan
{
    ...
    public class FormScan : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button_browse_cgi_file.TabIndex = 1;
            ...
            this.textBox_cgi_file.TabIndex = 0;
            ...
            this.numericUpDown_wait_between_scan.TabIndex = 6;
            ...
            this.checkBox_delay_between_scan.TabIndex = 2;
            ...
            this.checkBox_hexa_data.TabIndex = 1;
            ...
            this.comboBox_proxy_type.TabIndex = 2;
            // 
            // label4
            // 
            ...
            this.button_browse_proxy_file.TabIndex = 5;
            ...
            this.textBox_proxy_list_file.TabIndex = 4;
            ...
            this.textBox_ip_to_check_proxy.TabIndex = 7;
            ...
            this.checkBox_check_proxy.TabIndex = 6;
            ...
            this.checkBox_use_proxy.TabIndex = 0;
            ...
            this.checkBox_tcp_wait_for_data.TabIndex = 8;
            ...
            this.checkBox_random_order.TabIndex = 7;
            ...
            this.radioButton_splited_ip_port_list.TabIndex = 3;
            ...
            this.button_browse_same_ipport_list_file.TabIndex = 2;
            ...
            this.textBox_same_ip_port_file.TabIndex = 1;
        ...
        private scan_information get_remaining()
        {
            ...
            if (this.checkBox_random_order.Checked)// if random order (else take the first element
                index=(int)System.Math.Floor((double)this.rnd.Next(this.al_full_scan_infos.Count));
            // get member
    ...
    public class icmp_scan:easy_socket.icmp.icmp_echo
    {
        ...
        public icmp_scan(FormScan formscan,string ip, int id)
        {
            ...
            catch
            {
                ...
                {
                    // an error will be send when packet will be sent (see ip_header_client.send_without_forging)
                }
            }
