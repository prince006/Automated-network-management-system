...
namespace Smart_NET
{
    public class FormPing : Smart_NET.CommonTelnetForm
    {
		...
		private int i_delay_between_ping_sending;
        ...
        private void InitializeComponent()
        {
			...
			this.panel.Size = new System.Drawing.Size(472, 274);
			// 
			// textBox_editable
			// 
			this.textBox_editable.Location = new System.Drawing.Point(0, 205);
			this.textBox_editable.Name = "textBox_editable";
			this.textBox_editable.Size = new System.Drawing.Size(264, 68);
			// 
			// panel_control
			// 
			...
			this.panel_control.Size = new System.Drawing.Size(208, 274);
			// 
			// textBox_telnet
			// 
			this.textBox_telnet.Name = "textBox_telnet";
			this.textBox_telnet.Size = new System.Drawing.Size(264, 205);
			// 
			// button_ping
			// 
			this.button_ping.Location = new System.Drawing.Point(64, 248);
			...
			// panel_data
			// 
			this.panel_data.Controls.Add(this.textBox_icmp_delay_between_ping_sending);
			...
			this.textBox_icmp_ping_number.TabIndex = 7;
			...
			this.textBox_icmp_delay_dor_reply.TabIndex = 3;
			...
			this.textBox_icmp_packet_ttl.TabIndex = 5;
			...
			// 
			this.checkBox_icmp_looping_ping.Location = new System.Drawing.Point(8, 152);
			...
			this.checkBox_icmp_looping_ping.TabIndex = 8;
			...
			this.label1.Text = "Delay in ms between ping sending";
			// 
			// textBox_icmp_delay_between_ping_sending
			// 
			this.textBox_icmp_delay_between_ping_sending.Location = new System.Drawing.Point(152, 112);
			this.textBox_icmp_delay_between_ping_sending.Name = "textBox_icmp_delay_between_ping_sending";
			this.textBox_icmp_delay_between_ping_sending.Size = new System.Drawing.Size(48, 20);
			this.textBox_icmp_delay_between_ping_sending.TabIndex = 11;
        ...
        private void send()
        {
			...
			// other ping sending will be done on events (timeout, reply, ...)
        }
        /// <summary>
        ...
        private void send_if_necessary()
        {
			...
			// if a delay between ping sending is requested
			if (this.i_delay_between_ping_sending!=0)
			{
				System.Threading.Thread.Sleep(this.i_delay_between_ping_sending);
			}
            // if looping ping
            if (this.b_looping)
            {
        ...
        private bool get_values()
        {
			...
			this.i_delay_between_ping_sending = System.Convert.ToInt32(this.textBox_icmp_delay_between_ping_sending.Text,10); 
